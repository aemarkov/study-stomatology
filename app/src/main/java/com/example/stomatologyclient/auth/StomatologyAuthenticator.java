...
import com.example.stomatologyclient.activity.NewAccountActivity;

/**
 * Менеджер аккаунтов
 */
public class StomatologyAuthenticator extends AbstractAccountAuthenticator
{
    Context mContext;

    public StomatologyAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
